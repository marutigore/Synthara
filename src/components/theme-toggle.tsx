...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <Button variant="ghost" size="icon" className="rounded-full text-foreground/70" disabled>
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="relative rounded-full text-foreground/70 hover:text-foreground hover:bg-foreground/10 transition-all duration-300"
